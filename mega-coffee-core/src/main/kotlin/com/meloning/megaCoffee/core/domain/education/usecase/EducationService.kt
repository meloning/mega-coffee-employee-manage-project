...
import com.meloning.megaCoffee.core.domain.education.usecase.command.RegisterEducationAddressCommand
...
class EducationService(
    ...
    fun registerAddress(id: Long, command: RegisterEducationAddressCommand) {
